...
if __name__ == '__main__':
    ...
    if opt.dstype == 'v1':
        ...
        test_dataset = DatasetImg(opt.root + '/test/img', opt.test + '/test/label', imgW=opt.imgW)
    elif opt.dstype == 'v2':
        print('Sử dụng dataset_v2')
        train_dataset = DatasetImg_v2(opt.root + '/train/img', opt.root + '/train/label', imgW=opt.imgW)
        test_dataset = DatasetImg_v2(opt.root + '/test/img', opt.test + '/test/label', imgW=opt.imgW)
